...
var __decorate = this && this.__decorate || function(e, t, o, i) {
    ...
    if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) s = Reflect.decorate(e, t, o, i); else for (var c = e.length - 1; c >= 0; c--) (r = e[c]) && (s = (n < 3 ? r(s) : n > 3 ? r(t, o, s) : r(t, o)) || s);
...
var core_1 = require("@angular/core"), FoldersComponent = function() {
    ...
    return e.prototype.ngOnInit = function() {
        ...
        this.show_rename = !this.show_rename, e.childNodes[1].childNodes[1].classList.add("js-show_rename"), 
        e.childNodes[1].childNodes[1].focus();
    }, e.prototype.onBlur = function() {
        var e = document.getElementsByClassName("js-show_rename")[0];
        e && e.classList.remove("js-show_rename");
        ...
        this.listService.sel_image && this.listService.sel_image.id == e || (this.listService.sel_file = this.listService.getFolder(e), 
        this.select.emit(e));
    }, e;
}();
